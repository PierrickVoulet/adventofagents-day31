...
"""Contains A2UI schema definitions."""
                ...
                "properties": {
                  ...
                  "WebFrame": {
                    ...
                    "properties": {
                      "url": {
                        "type": "object",
                        "description": "The URL of the web page to display. This can be a literal string ('literalString') or a reference to a value in the data model ('path', e.g. '/page/url').",
                        "properties": {
                          "literalString": {
                            "type": "string"
                          },
                      ...
                      "htmlContent": {
                        "type": "object",
                        "description": "The HTML content to display. This can be a literal string ('literalString') or a reference to a value in the data model ('path', e.g. '/page/html').",
                        "properties": {
                          "literalString": {
                            "type": "string"
                          },
                      ...
                      "height": {
                        "type": "number",
                        "description": "The height of the web frame in pixels. If not provided, the frame will use a default aspect ratio."
                      },
                      "interactionMode": {
                        "type": "string",
                        "description": "The interaction mode of the web frame. One of 'readOnly' or 'interactive'. Defaults to 'readOnly'.",
                        "enum": ["readOnly", "interactive"]
                      },
                      "allowedEvents": {
                        "type": "array",
                        "description": "A list of event names that are allowed to be sent from the web frame to the agent.",
                        "items": {
                          "type": "string"
                        }
                      }
